package com.busanit501.leejj_server_project2._0205_todo.controller;

import com.busanit501.leejj_server_project2._0205_todo.dto._0205_2_TodoDTO;
import com.busanit501.leejj_server_project2._0205_todo.service._0205_1_TodoService;
...
@WebServlet(name = "_0205_6_TodoListController", urlPatterns = "/todo/list_0205")
...
//        log.info("log4j2를 이용해서, 기록하기. ");
        ...
        try {
            ...
            // 결과 화면으로 안내.
            req.getRequestDispatcher("/WEB-INF/_0205_todo/list.jsp")
                    .forward(req,resp);
        } catch (Exception e) {
