package com.busanit501.leejj_server_project2._0206_todo.dao;
...
public class _0206_3_TodoDAO {
    ...
    public String getTime() {
        ...
        try (Connection connection = _0206_7_ConnectionUtil.INSTANCE.getConnection();
             // 현재 시간을 조회하는 쿼리를 전달하고
    ...
    public String getTime2() throws Exception {
        ...
        @Cleanup Connection connection = _0206_7_ConnectionUtil.INSTANCE.getConnection();
        // 현재 시간을 조회하는 쿼리를 전달하고
    ...
    public void insert(_0206_5_TodoVO vo) throws Exception {
        // sql 문장 작성,
    ...
    // 목록 기능 구현하기.
    public List<_0206_5_TodoVO> selectAll() throws Exception {
        // sql 문장 작성,
        ...
        // 임시로 담아둘 리스트를 선언
        List<_0206_5_TodoVO> list = new ArrayList<>();
...
//     3행   4,샘플제목22,2026-02-03,0
        ...
        while (resultSet.next()) {
            ...
            _0206_5_TodoVO vo = _0206_5_TodoVO.builder()
    ...
    public _0206_5_TodoVO selectOne(Long tno) throws Exception {
        // sql 문장 작성,
...
//     1행   4,샘플제목22,2026-02-03,0
    ...
    public void updateOne(_0206_5_TodoVO todoVO) throws Exception {
