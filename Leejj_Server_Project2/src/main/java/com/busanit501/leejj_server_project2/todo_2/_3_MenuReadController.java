...
@WebServlet(name="_3_TodoReadController_0202_02", urlPatterns = "/todo/read_0202_02")
public class _3_MenuReadController extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // 웹브라우저에서, 주소 요청 : http://localhost:8080/todo/read_0202_02?tno=100
...
//        req.getParameter("tno") => 문자열이기 때문에, 우리는 파싱해서, 다시 숫자 형태로 변경.
        ...
        // 화면에 전달
        req.getRequestDispatcher("/WEB-INF/_0202_todo_2/_3_todoRead.jsp").forward(req,resp);
    }
