package com.busanit501.leejj_server_project2._0204_todo.service;

import com.busanit501.leejj_server_project2._0204_todo.dao._0204_5_TodoDAO;
import com.busanit501.leejj_server_project2._0204_todo.domain._0204_2_TodoVO;
import com.busanit501.leejj_server_project2._0204_todo.dto._0204_1_TodoDTO;
import com.busanit501.leejj_server_project2._0204_todo.util._0204_3_MapperUtil;
...
//        System.out.println("_0204_4_TodoService에서 register 작업중, 변환 결과 확인 todoVO : " + todoVO);
    ...
    public List<_0204_1_TodoDTO> listAll() throws Exception {
        ...
        //DAO로 데이터베이스의 데이터를 가져오면, 타입을 _0204_2_todoVO로 받음(변환작업)
